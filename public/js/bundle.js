...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmFrdGVybmEiLCJhIjoiY2t2bXExYTEwMWlkbTJ1dGsyeHc0MGpnayJ9.uLF-1rFXh5EwF8bIr_0T0g';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your sign up is a success');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51JvQpFJYHR4prLP9pHToRs6VU3x6LcnKkikkyUtQiT94IeJU39q8lfI1SVnT6p0g72n6qTpFyolH9p0Y4sOQfA9a00BrLyzhBN');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            document.querySelector('.btn--save-settings').textContent = 'Save Setting...';
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.querySelector('.sign-name').value;
    var email = document.querySelector('.sign-email').value;
    var password = document.querySelector('.sign-password').value;
    var passwordConfirm = document.querySelector('.sign-confirm').value;
