...
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    ...
    // Excrypt the cookie, can only be used in https
    // secure: true,
    // Cookie cannot be accessed or modified. Can only be sent with https
    // Autosend back to server for every request from client
    httpOnly: true
  };
